...
import { EditAddModalProps } from '../../utils/types';

const CustomEditAddModal3: React.FC<Partial<EditAddModalProps>> = ({
  open,
  mode,
  columns,
  initial,
  ...
  return (
    ...
    >
      ...
      >
        <h3 style={{ marginTop: 0 }}>{mode} Employee (Custom Form)</h3>
...
export default CustomEditAddModal3;
